<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin')}}">
      <div class="sidebar-brand-icon">
        <img src="{{asset('frontend/img/NovaCart-Logo.png')}}" alt="NovaCart Logo" style="width: 40px; height: auto;">
      </div>
      <div class="sidebar-brand-text mx-3">NovaCart</div>
    </a>
    ...
    <hr class="sidebar-divider d-none d-md-block">
    <div class="sidebar-social-icons text-center">
        <div class="sidebar-social-links">
            <a href="#" class="sidebar-social-link facebook" title="Facebook">
                <i class="fab fa-facebook-f"></i>
            </a>
            <a href="#" class="sidebar-social-link twitter" title="Twitter">
                <i class="fab fa-twitter"></i>
            </a>
            <a href="#" class="sidebar-social-link instagram" title="Instagram">
                <i class="fab fa-instagram"></i>
            </a>
            <a href="#" class="sidebar-social-link youtube" title="YouTube">
